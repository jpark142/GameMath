...
void SoftRenderer::LoadScene3D()
{
	...
	Vector3 cameraDistance = Vector3(0.f, 0.f, 500.f);
	mainCamera.GetTransform().SetPosition(goPlayer.GetTransform().GetPosition() - cameraDistance);
